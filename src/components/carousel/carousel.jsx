...
// Desktop images
import ValentineDesktop from "./caption/hello.png";
...
// Mobile images
import ValentineMobile from "./caption/mobile/val.png";
...
const Carousel = () => {
  ...
  return (
    <>
      <div className="" style={{ background: "#f8f8f8", position: "relative" }}>
        <Swiper
        ...
        >
          ...
          <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
            <div
              ...
              style={{
                backgroundImage: `url(${
                  isMobile ? ConsultMobile : ConsultDesktop
                })`,
                position: "relative",
              }}
            >
          ...
          <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
            <div
              ...
              style={{
                backgroundImage: `url(${
                  isMobile ? DigitalMobile : DigitalDesktop
                })`,
                position: "relative",
              }}
            >
          ...
          <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
            <div
              className="carouselCard"
              style={{
                backgroundImage: `url(${isMobile ? WebMobile : WebDesktop})`,
                position: "relative",
              }}
            >
              {/* <Snowflakes count={15} heroOnly={true}/> */}
          ...
          <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
            <div
              className="carouselCard"
              style={{
                backgroundImage: `url(${isMobile ? TechMobile : TechDesktop})`,
                position: "relative",
              }}
            >
              {/* <Snowflakes count={15} heroOnly={true}/> */}
              <div className="carouselCardPadding">
                <div className="text-start carouselText">
                  ...
                  <Link
                    ...
                    className="btn btn-lg btn-danger cta"
                    aria-label="Learn more about hardware engineering and related technologies"
                  >
                    Know More
                  </Link>
                </div>
