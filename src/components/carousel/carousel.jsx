...
<div className="swiper-button-next" style={{color:"#fff",fontSize:"18px",margin:"0 0px", cursor:"pointer",float:"right"}}></div>
 <div className="swiper-button-prev" style={{color:"#fff",fontSize:"18px",margin:"0 0px", cursor:"pointer",float:"left"}}></div>
  ...
  <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary"  >
    <div className='carouselCard' style={{ backgroundImage: `url(${Consult})`}}>
  ...
  <SwiperSlide className="swiper-slide bg-secondary"  >
    <div className='carouselCard' style={{ backgroundImage: `url(${Digital})`}}>
      <div class="carouselCardPadding">
          <div class=" text-start carouselText">
  ...
  <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
    <div className='carouselCard' style={{ backgroundImage: `url(${Web})`}}>
      <div class="carouselCardPadding" >
          <div class="text-start carouselText">
  ...
  <SwiperSlide className="swiper-slide swiper-no-swiping bg-secondary">
    <div className='carouselCard' style={{ backgroundImage: `url(${Tech})`}}>
      <div class="carouselCardPadding">
          <div class=" text-start carouselText">
