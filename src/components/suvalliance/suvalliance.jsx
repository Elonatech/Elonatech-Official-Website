...
<div class="container-fluid surveillance-section">
  <div class="text-content">
    <h2>Surveillance</h2>
    <h5>A good way for you to protect yourself is to consider a video surveillance.</h5>
    <p class="lead">While network security should always be a prime concern for your business, you shouldn’t neglect your physical security either.</p>
  </div>
</div>
				...
				<div class="row justify-content-between">
					<div class="col-md-8 col-lg-8 d-flex align-items-center">
						<div class="w-100 py-4">
							<h2 class="text-dark fw-bold mb-4">Warn off intruders from your home</h2>
							<p  class="text-dark">
              If someone’s lurking around your home, tell them it’s time to leave using the camera’s two-way audio. 
              And whenever your burglary sensors go off, your camera’s built-in siren will go off too — alerting 
              the neighbors and sending intruders running.
              </p>
						</div>
					</div>
					<div class="col-md-4 col-lg-4 d-flex align-items-end ">
            <div className="text-center">
            <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1706956614/surveillance/Smile-Desktop_klsmqf.png" className='img-fluid lazyload' alt="" />
            </div>
					</div>
				</div>
			</div>
...
<div className="container mt-5 mb-5">
    <div className="row">
        ...
        <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709635933/surveillance/Video-Icon_xp0fyx.svg" className='lazyload' alt="" /><br />
        <h5>High-definition video</h5>
        <h6>Watch what’s happening in 1080p HD video with 8x digital zoom.</h6>
        </div>
        <div className="col-md-4">
        <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709635936/surveillance/Cloud-Icon_zip0au.svg" className='lazyload' alt="" /><br />
        <h5>Unlimited cloud storage</h5>
        <h6>Your videos are saved automatically on our secure servers for 30 days.*</h6>
        </div>
        <div className="col-md-4 mt-3">
        <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709635934/surveillance/Battery_s82mei.svg" className='lazyload' alt="" />
  ...
  <div className="row">
    <div className="col-md-6">
      <div className="card border-0 text-center">
        <img   data-src="https://res.cloudinary.com/elonatech/image/upload/v1706955253/surveillance/image_26_ksokim.png" className='img-fluid lazyload' alt="" />
      </div>
      </div>
      <div className="col-md-6">
      <div className="">
      <h4 className='fw-bold'>What Makes a Video Surveillance System?</h4>
      {/*  */}
      <p className='mt-3'>
      A video surveillance system / CCTV is composed of a system of cameras, monitors/display units, and recorders. 
      Cameras may be either analog or digital with a host of possible design features which will be discussed momentarily.
      <br />
      <br />
      These systems can be applied to both interior and exterior areas of a building or property. 
      They can operate 24/7, can be designed to only record in response to movement, or set to record during specific times of the day.
      <br />
      <br />
      The cameras may be conspicuous and out in the open to deter crime, or they can be more hidden and discreet to record evidence with fewer chances of being tampered with. 
      However, it is essential to note that laws regulate the placement of security cameras within the workplace. 
      These laws vary from state to state, so be sure to contact your state’s labor agency to learn what your restrictions are.
      <br />
      <br />
      Footage can be monitored live by a security guard, monitored remotely if using an IP camera and system (more on that in a moment) by a monitoring company, 
      or can simply be recorded and stored 
      by a DVR (digital video recorder) or NVR (network video recorder) for review later should the need arise.
      <br />
      <br />
      Finally, video surveillance systems are closed – this means its signals are not broadcast so that others could intercept and view the content. 
...
<div className="container  mt-5 bg-secondary p-5 rounded">
    <div className="row align-items-center">
            ...
            <ul className='list-unstyled'>
                <li className='mt-4'>
                    <div className="d-flex">
                     <img src="https://res.cloudinary.com/elonatech/image/upload/v1709635934/surveillance/Battery_s82mei.svg" alt="" className='mb-4' />
                    <div className="mt-5">
                ...
                <li className='mt-4'>
                    ...
                    <div className="mt-2">
                    <h5 className='ps-5'>High-definition video</h5> <h6 className='ps-5'>Watch what’s happening in 1080p HD video with 8x digital zoom.</h6>
                    </div>
                    </div>
                </li>
                {/*  */}
                <li className='mt-4'>
                    ...
                    <div className="mt-2">
                    <h5 className='ps-5'>See in color at night</h5> <h6 className='ps-5 '>A built-in spotlight + HDR let you see clearly 24/7.</h6>
                    </div>
                    </div>
                </li>
        ...
        <div className="col-md-6">
          <div className="text-center">
            <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709635654/surveillance/Shield-expanded_csd60b.webp"  className='img-fluid lazyload' alt="" />
          </div>
        </div>
    </div>
</div>
...
<section id="" class="survalliance mb-5 mt-5">
      <div class="container bg-white" >
        ...
        <div class="col-lg-4">
              <div className=" text-center">
                <h2 className='FAQ' style={{fontWeight:"800"}}>FREQUENTLY ASKED QUESTIONS</h2>
