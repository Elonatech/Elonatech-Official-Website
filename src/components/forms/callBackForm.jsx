...
<button className="btn btn-primary cvb border border-light text-light mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal4"><h6 className="mt-1">Click Here</h6></button>
{/* ================================================ body  ============================================== */}
<div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4 fw-bold text-dark" id="exampleModalLabel">Get in Touch with us</h1>
      ...
      <form>
            <div class="mb-2 mt-4">
              ...
              <input  class="form-control" id="what" value={number} onChange={handleChangeNumber}  />
