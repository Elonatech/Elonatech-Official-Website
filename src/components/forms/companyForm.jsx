...
const CompanyForm = () => {
  ...
  const validateForm = () => {
    ...
    if (!letter.trim()) errors.push("Cover letter is required.");
  ...
  return (
    <>
      <a
        className="btn btn text-white py-3 px-5 mt-3 wow zoomIn"
        data-wow-delay="0.11s"
        style={{ backgroundColor: "#435d8b", cursor: "pointer" }}
      ...
      {showModal && (
        <>
          ...
          <div className="applymodal-wrapper" role="dialog" aria-modal="true" aria-labelledby="company-modal-title">
            <div className="applymodal-box">
              <div className="applymodal-header">
                <div>
                  <h2 id="company-modal-title" className="applymodal-title">Request A Quote</h2>
