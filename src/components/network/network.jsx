...
<Helmet>
       ...
       <meta name="description" content="Here at Elonatech, 
...
{/*====================================================================================== header ============================================================*/}
<div class="container-fluid network-equipment-maintenance-section">
  <div class="text-content">
    <h2>Network Equipment Maintenance</h2>
    <h5>We Provide Round-The-Clock Maintenance for All Network Equipment</h5>
    <p class="lead">Committed to supplying you with the most reliable network advice, support, and services at all times.</p>
  </div>
</div>
...
<div class="row justify-content-md-center gy-3 align-items-center">
      <div class="col-md-6  ">
        <div className="text-center">
         <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={firstNetwork} alt="" className='img-fluid lazyload rounded' />
        </div>
      </div>  
      <div class="col-md-6">
      <div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={secondaNetwork} alt="" className='img-fluid lazyload rounded' />
        </div>
      </div>
    </div>
</div>
...
<div class="row justify-content-md-center align-items-center">
      <div class="col-md-6  ">
      <div className="text-center">
         <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={thirdNetwork} alt="" className='img-fluid lazyload rounded' />
      </div>

      </div>  
      <div class="col-md-6">
      <div className="text-center">
         <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={fourthNetwork} alt="" className='img-fluid lazyload rounded' />
      </div>
      </div>
    </div>
</div>
...
<main class="container mt-5 ">
  <div class=" p-md-2 mb-4 rounded" style={{backgroundColor:"#002e62"}}>
    ...
    <div class="col-md-6">
      ...
      <strong>H</strong>ere at Elonatech, we are committed to supplying you with the most reliable advice, support and services at all times,  wherever you are in Nigeria.
     <br />
     To find out more about how we can help you, please get in touch with us today.
      </p>
    </div>
    <div class="col-md-6">
    <img data-src={reliableSupport} class="img-fluid lazyload" alt="Responsive image" style={{height:"15rem", width:"79rem"}}/>
    </div>
    </div>
  </div>
</main> 
  ...
  <div class="rounded">
    ...
    <div class="col-md-6 common">
        <h3 className='text-center  mt-5 mb-3' style={{color:'#34548c'}}>Common Network Devices We Maintain</h3>
         <div className="text-center">
         <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={networkDevices} alt="" className='img-fluid lazyload rounded' />
        </div>
    </div>
...
<main class="container mb-5">
  <div class="rounded">
    ...
    <div class="col-md-6 p-4 text-white" style={{backgroundColor:"#002e62"}}>
     ...
     <br /> <br />  That is why Elonatech offers industry-leading network and wireless hardware repair services. With expert technical staff and an advanced tech center, we are well suited to serve your repair needs.</p>
    </div>
    <div class="col-md-6 common-router">
        <h3 className='text-center  mt-5 mb-3' style={{color:'#34548c'}}>Network & Wireless Network Equipment Repair</h3>
         <div className="text-center">
         <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={wirelessNetwork} alt="" className='img-fluid lazyload rounded' />
        </div>
    </div>
    </div>
  </div>
