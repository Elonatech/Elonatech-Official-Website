...
<Helmet>
       ...
       <meta name="description" content="Network Security Reasons Why Network Security Is Important. Cybersecurity Assessment Email Software-defined Perimeter security Mobile Device Security Intrusion Detection " />
       <link rel="canonical" href="https://elonatech.com.ng/network-security" />
</Helmet>

{/*=============================================== Header =================================================*/}
<div class="container-fluid network-security-section">
  <div class="text-content">
    <h2>Network Security</h2>
    <h5>Involves the authorization of access to data in a network</h5>
    <p class="lead">Policies, Processes and Practices adopted to prevent, detect and monitor unauthorized access, misuse, modification, or denial of a computer</p>
  </div>
</div>
 ...
 <div className="container mb-5">
    <div className="row g-0 align-items-center">
        ...
        <div className="col-md-6">
            ...
            <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={FirstSecurityImage} className='img-fluid lazyload' alt="" />
            </div>
        </div>
    </div>
 </div>
...
<div className="container">
    <div className="row ">
        <div className="col-md-3">
                ...
                <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709631131/networkSecurityPage/Icon1_raaxvh.svg" className='img-fluid lazyload' style={{height:"4rem", weight:"4rem"}} alt="" />
                 <p className='text fs-5 ms-3'>Cybersecurity Assessment </p>
            </div>
        </div>
        <div className="col-md-3">
                <div className="card-body d-flex">
                <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709631132/networkSecurityPage/Icon2_dxz8cg.svg" className='img-fluid lazyload'  style={{height:"4rem", weight:"4rem"}} alt="" />
                 <p className='text fs-5 ms-3'>Cyber Risk Quantification</p>
            </div>
        </div>
        <div className="col-md-3">
                <div className="card-body d-flex">
                <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709631134/networkSecurityPage/Icon3_xygxid.svg" className='img-fluid lazyload'  style={{height:"4rem", weight:"4rem"}} alt="" />
...
<div className="container">
    <div className="row align-items-center">
       <div className="col-md-7">
            <div className="text-center">
            <img src="https://i.stack.imgur.com/qq8AE.gif" data-src={SecondSecurityImage}  className='img-fluid lazyload' alt="" />
            </div>
        </div>
