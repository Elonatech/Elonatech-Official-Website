...
const Printer = () => {
 ...
 <>
 <Helmet>
       <title>Printer Repair & Maintenance - Tech Solution, Digital Solution</title>
       <meta name="description" content="Maintaining the printer and copier in your office is very important. Keeping up with all necessary printer repair and maintenance is the best way to protect your valuable investment. It also ensures that your business will remain productive and avoid frustrating delays due to printer malfunction
...
" />
 ...
 {/*================================================================================ header ====================================================================*/}
 <div class="container-fluid printer-repair-section">
  <div class="text-content">
    <h2>Printer Repair & Maintenance</h2>
    <h5>Keeping Up with all Necessary Maintenance is The Best Way to Protect your Investment</h5>
    <p class="lead">A malfunctioning or out of service printer, copier or multifunction device can be disastrous for your business</p>
  </div>
</div>
...
{/*=======================================================================================*/}
 <div class="container">
  <div class="container-fluid">
    <h2 class=" mt-5 fw-bold  text-center" style={{color:"#34548c"}}>Maintaining Your Printer, Copier & Scanner</h2>
        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-lg-3 g-2">
          <div class="col rounded-start" style={{backgroundColor:"#34548c"}}>
            <div class="card mt-1 mb-1 shadow-sm" style={{height:"380px"}}>
              ...
              <img data-src={externalHome} className='card-img-top lazyload text-center' style={{height:"4rem" , width:"4rem"}} alt="" />
              </div>
              <div class="card-body">
          ...
          <div className="card mt-1 mb-1" style={{height:"380px" , backgroundImage:`url(${Maintaining})` , backgroundRepeat:"no-repeat", backgroundSize:"cover" }}></div>
          </div>
          <div class="col rounded-end " style={{backgroundColor:"#34548c"}} >
          <div class="card mt-1 mb-1 shadow-sm" style={{height:"380px"}}>
              <div className="text-center mt-4">
              <img data-src={externalPrinter} className='card-img-top lazyload text-center' style={{height:"4rem" , width:"4rem"}} alt="" />
              </div>
              <div class="card-body">
                <h5 className='text-center'>Printer installation and Configuration</h5>
                <p  class="text-center fs-6 mb-4">
                Our Printer Repair Technicians is highly skilled and proficient in the regular and routine repairs, 
                including replacements, installation and configuration of new printers, maintaining and ensuring the 
                proper functioning of standalone printers, scanners or Network Printers.
                </p>
              </div>
            </div>
          </div>
...
<div class="row justify-content-md-center align-items-center">
      <div class="col-md-6">
        ...
        <img src='https://res.cloudinary.com/elonatech/image/upload/v1710165001/loaderImage/qq8AE_a5blke.gif' data-src={Repair} alt=""   className='img-fluid  lazyload rounded' />
        </div>
      </div>
      <div class="col-md-6">
...
<div className="container-fluid" style={{backgroundColor:"#34548c"}}>
  ...
  <div className="col-md-7">
    <div className="card mt-5" style={{border:"none" , backgroundColor:"#34548c"}}>
      <img className='img-fluid lazyload'   data-src={Specialist} alt="" />
    </div>
  </div>
  </div>
</div>
