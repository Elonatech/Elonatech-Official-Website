...
const Server = () => {
  ...
  <>
{/*============================================================================== header =====================================================*/}
<div class="container-fluid server-administration-section">
  <div class="text-content">
    <h2>Server Administration</h2>
    <h5>Monitor, Configure and Maintain Servers to operate reliably and optimally</h5>
...
<main class="container mt-5">
  <div class="p-2  mb-4 rounded shadow" style={{backgroundColor:"#34548c"}}>
    ...
    <div class="col-md-7">
    <div className="card border-0 text-white" style={{backgroundColor:"#34548c"}}>
    <h4 className='ps-3 fw-bold mb-3' >Key Objectives of Server Administration</h4>
    <ul className='list-unstyled ps-3'>
         <li className='d-flex mb-3' ><i class="bi bi-hdd-stack fs-3 me-3"></i> <h6 className='mt-2'>Minimize server slowdowns and downtime while maximizing reliability.</h6></li>
         <li className='d-flex mb-3' ><i class="bi bi-hdd-stack fs-3 me-3"></i> <h6 className='mt-2'>Secure and protect server environments.</h6></li>
         <li className='d-flex mb-3' ><i class="bi bi-hdd-stack fs-3 me-3"></i> <h6 className='mt-2'>Scale servers and related operations to meet the needs of the organization over time.</h6></li>
    </ul>
    </div>     
    </div>
 </div>
...
<section id="services" class="servic section-bg mb-5">
      <div class="container">
        <div class="section-header">
          <h2 className='text-center mt-5 fw-bold'>Why Choose Elonatech For Your Server Administration</h2>
          <div className='mb-5 ' style={{backgroundColor:"#dc3545", height:"2px", width:"80px", margin:'auto'}}></div>
        </div>
        <div class="row gy-4">
