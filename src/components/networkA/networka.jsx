          ...
          <div className='col-md-6 mb-3'>
            ...
            >
              <div class='text-bg-light shadow py-4 rounded'>
                ...
                <p class='p-3 fs-6' style={{ textAlign: 'justify' }}>
                  Due to the demands of today's growing economy and virtual IT
                  environments, Organizations are beginning to rely on scalable
                  and reliable IT infrastructure. Elonatech helps clients
                  determine most effective technologies that will provide
                  maximum productivity. Whether your business is looking to
                  build a whole new network in an already existing area or to
                  add on to your existing infrastructure, we will design it from
                  conceptualization, with all of your needs in mind. <br />
                </p>
      {/*==================================================================== The new reponsive one ======================================================*/}
      <div className='container mt-5'>
        <div className='row'>
            ...
            >
              <div class='text-bg-light shadow py-4 rounded'>
                ...
                <p class='p-2' style={{ textAlign: 'justify' }}>
                  ...
                  network monitoring, network management, and maintaining
                  network quality and security. <br /> Elonatech supports all
                  the networks we implement and support existing ones. Any
                  issues you have from desktops and laptops to servers,
                  networking hardware and printers we will assess, investigate
                  and proffer a solution{' '}
                </p>
              </div>
            </div>
            {/* </div> */}
      ...
      <div className='container my-5'>
        <div className='row justify-content-center align-items-center'>
          ...
          <div className='col-md-6'>
            ...
            >
              <h5 className='text-center text-white pt-5'>
                WHY DO I NEED A NETWORK ADMINISTRATOR?
              </h5>
              <p
                className='px-3 pt-3 text-white'
