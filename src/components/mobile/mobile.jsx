...
<div class="container-fluid mobile-device-repair-section">
  <div class="text-content">
    ...
    <p class="lead">We assess mobile phones functionality, install and update phone software, troubleshoot wiring problems, and replace damaged parts.</p>
  </div>
</div>
        ...
        <div class="row gy-4 mt-5">
          <div class="col-md-12 col-md-12">
             <div class="text-bg-light shadow py-4 rounded">
              ...
              <p class="lead my-3 text-center"><img data-src={Shadow} alt="" style={{height:"3rem" , width:"4rem"}} className='lazyload' />Elonatech provides customers with excellent phone repair services with well-trained team of repair technicians, top quality parts and timely customer care support.</p>
             </div>
          </div>
        </div>
      </div>
...
<div class="row justify-content-md-center align-items-center">
      ...
      <div className="text-center">
       <img src="https://i.stack.imgur.com/qq8AE.gif" data-src={PhoneRepair} className='img-fluid lazyload rounded'  alt="" />
      </div> 
      </div>
</div>
  ...
  <p className='text-white p-4' style={{textAlign:"justify"}}>
    ...
    <div className="col-md-6" >
      <div className="text-center" style={{backgroundColor:"#3f556d"}}>
        <img src="https://i.stack.imgur.com/qq8AE.gif" data-src={BannerFlip} className='img-fluid lazyload'  alt="" />
      </div> 
    </div>
  </div>
</div> 
...
<div class="row g-4 justify-content-md-center align-items-center ">
      <div class="col-md-6">
        <div className="text-center" >
        <img src="https://i.stack.imgur.com/qq8AE.gif" data-src={mobileRight} alt="" style={{height:"19rem"}}   className='img-fluid lazyload rounded shadow' />
        </div>
      </div>
      <div class="col-md-6">
