...
const Integration = () => {
   ...
   <Helmet>
       ...
       <meta name="description" content="Building intelligence system to better your business' efficiency and profit  Physical Layer Network Layer Storage Layer" />
       <link rel="canonical" href="https://elonatech.com.ng/system-integration" />
  </Helmet>
...
<div class="container-fluid infrastructure-section">
  <div class="text-content">
    ...
    <h5>Building intelligence systems to better your business' efficiency and profit</h5>
    <p class="lead">Integrating existing, and often disparate systems in a way that focuses on increasing value</p>
  </div>
</div>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
  <div class="col-md-3">
    ...
    <div className="text-center">
        <img  data-src={SecondInfastructureImage}  style={{width:"100%" , height:"225px"}} className='img-fluid lazyload' alt="" />
    </div>
      <div class="card-body">
  ...
  <div class="col-md-3">
    ...
    <div className="text-center">
          <img data-src={ThirdInfastructureImage} style={{width:"100%" , height:"225px"}} className='img-fluid lazyload' alt="" />
    </div>
      <div class="card-body">
  ...
  <div class="col-md-3">
    <div class="card shadow-sm border-0 rounded">
    <div className="text-center">
     <img  data-src={FourthInfastructureImage} style={{width:"100%" , height:"225px"}} className='img-fluid lazyload' alt="" />
    </div>
      <div class="card-body">
  ...
  <div class="col-md-3">
    ...
    <div className="text-center">
     <img  data-src={FifthInfastructureImage} style={{width:"100%" , height:"225px"}} className='img-fluid lazyload' alt="" />
    </div>
      <div class="card-body">
...
{/*==================================================================== System Integrator ====================================================================*/}
<div className="container-fluid" style={{ backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${BannerInfastructureImage})`, backgroundRepeat:"no-repeat" , backgroundPosition:"center", backgroundSize:"cover" , height:"390px"}}>
    <div className="container">
        <div class="row justify-content-md-center">
            <div class="col-md-5 mb-5 ">
            <div className="text-center">
               <img src='https://res.cloudinary.com/elonatech/image/upload/v1710165001/loaderImage/qq8AE_a5blke.gif' data-src={SixthInfastructureImage} className='img-fluid lazyload' alt="" />
            </div>
            </div>
            <div class="col-md-7">
