...
<Helmet>
       ...
       <meta name="description" content="Where Connectivity Knows No Bounds - Weaving Your Digital World into One Seamless Experience. Elevate Your Digital Realm with the Velocity of Progress Where Faster Becomes the New Norm. Ignite Your Downloads with the Power of a Thousand Megabits Torrent of Possibilities at the Speed of Light " />
...
<div class="container-fluid internet-solution-section">
  <div class="text-content">
    ...
    <p class="lead">Offering you the best internet experience so you can enjoy guaranteed Superfast speeds to your network</p>
  </div>
</div>
...
<div className="container mb-5">
    <div className="row g-0">
        ...
        <div className="col-md-6">
            <div className="card rounded-0" style={{backgroundImage:`url(https://res.cloudinary.com/elonatech/image/upload/v1709623006/internetPage/p07br2yz_skl37i.jpg)`, backgroundPosition:"center" , backgroundSize:"40rem" , height:"310px"}}>
            </div>
        </div>
    </div>
 </div>
...
<div className="container mt-5 mb-5">
    <div className="row">
        <div className="col-md-6">
          ...
          <p className='fw-3 mt-3'>Embracing the Widest Range of Possibilities in the World of Internet Services, Seamless Connectivity, Lightning-Fast Speeds, Enhanced Security, and Unparalleled Customer Support Converge to Enable You to Navigate the Digital Frontier with Our Comprehensive and Cutting-Edge Features Solutions, Redefining How You Connect, Communicate, and Thrive in the Modern Digital Landscape.</p>
           <div className="row">
            <div className="col">
          ...
          <div className="row">
            <div className="col-md-6">
                ...
                <li>
                    ...
                    <p className='mt-2'>We operate different terminals on C- and Ku-Band. Our monitoring tools give access to...</p>
                    </div>
                    </div>
                   </li>
                    <li>
                    ...
                    <p className='mt-2'>Our back-up solutions put little strain on the budget and work reliably if your main...</p>
                    </div> 
                    </div>
                    </li>
                </ul>
            ...
            <div className="col-md-6">
                <ul className='list-unstyled'>
                    ...
                    <p className='mt-2'>From a small home office to a multi thousand user location. Our services are designed to meet specific.</p>
                    </div>
                    </div>
                   </li>
                    <li>
                    ...
                    <p className='mt-2'>Corporate and public bodies require secure and independent communication..</p>
                    </div> 
                    </div>
                    </li>
                </ul>
