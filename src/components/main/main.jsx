...
<div class="py-3">
  ...
  <h4 className='text-center pt-3'>Top-Notch Technology Service Provider.</h4>
  <h5 className='text-center pt-3'></h5>
  <div class="container"> 
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
      <div class="col-md-6 ">
        <div class="card shadow-sm me-auto " style={{backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.99), rgba(0, 0, 0, 0.5)), url(https://res.cloudinary.com/elonatech/image/upload/v1709804949/homePage/main/Scalable_IT_left-min_c8po5r.png)`}}>
          <div class="card-body">
            <h5 class="card-title text-white mt-3">Website and App Solutions</h5>
            <p class="card-text  text-white pt-2">At Elonatech, we build websites that are not only visually beautiful but also functionally effective. Our team of web strategists, designers, developers, and project managers work together to help clients meet their business objective</p>
            <div class="d-flex justify-content-between align-items-center pt-3">
              <Link className='btn btn-danger' to={'/web-design'}>Read More</Link>
            </div>
          </div>
        </div>
      </div>
      <div class="col-md-6 me-auto">
        <div class="card shadow-sm"   style={{ backgroundImage:`linear-gradient(0deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.99)), url(https://res.cloudinary.com/elonatech/image/upload/v1709804949/homePage/main/Scalable_IT_right-min_cjn5fe.png)`}}>
          <div class="card-body">
            <h5 class="card-title text-white mt-3">Flexible, Scalable IT Solutions</h5>
            <p class="card-text text-white pt-2">Having the right company behind your IT system is as important as the network itself. Implementing a well-designed, secured enterprise network and utilizing the right combination of IT solutions will drive your business to the desired level.</p>
            <div class="d-flex justify-content-between align-items-center pt-3">
            <Link className='btn btn-danger' to={'/system-integration'}>Read More</Link>
            </div>
          </div>
        </div>
      </div>
...
<div className="container mt-5 rounded" >
    <div className="row align-content-center">
        ...
        <div className="col-md-5 align-self-center">
          <div className="border-0">
          <img src="" data-src={ElonatechSupport} className='img-fluid lazyload' alt="" />
          </div>
        </div>
    </div>
</div>
{/*==================================================================== Marketing ============================================================*/}
  ...
  <div class="row  mt-5 ">
    <div class="col-md-7">
      <h3 class="fw-bold"> The IT Solutions and Corporate Consultant Company</h3>
      <p class="fs-6 p-2">
     ...
     <div class="col-md-5">
     <img src="" data-src={ElonatechOneStop} className='img-fluid lazyload' alt="" />
     </div>
    </div>
</div>
          ...
          <div className="row">
            <div className="col-md-2 col-6">
              <div className="card border-0">
                <img  src=""  data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234681/homePage/clientLogo/amp-featured-image_fincna.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234684/homePage/clientLogo/lsg_iph8mx.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234695/homePage/clientLogo/hv_nzxyt1.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234749/homePage/clientLogo/kosofe_yuqg5x.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234691/homePage/clientLogo/tru_h9afyy.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234742/homePage/clientLogo/feii_a8rzqg.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="carousel-item" >
      <div className="container">
          <div className="row">
            <div className="col-md-2 col-6">
              <div className="card border-0">
                <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234686/homePage/clientLogo/ireti_whpffr.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234744/homePage/clientLogo/remaben_yljc8l.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234696/homePage/clientLogo/domino_i6flnw.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234746/homePage/clientLogo/olajide_e245yh.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
            ...
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234690/homePage/clientLogo/home_mwhzd9.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
          </div>
        </div>       
...
{/*=================================================================== carousel 3 ====================================================================*/}
    ...
    <div className="container">
          <div className="row">
            <div className="col-md-2 col-6">
              <div className="card border-0">
                <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234739/homePage/clientLogo/safebrooks_smeauh.png" className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
            ...
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234687/homePage/clientLogo/okhma_hrxdi7.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234698/homePage/clientLogo/neyant_hesh5e.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234754/homePage/clientLogo/universal_vcrdgw.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234683/homePage/clientLogo/women_right_uet6bw.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
          </div>
        </div>
...
{/*=================================================================== carousel 4 ====================================================================*/}
    ...
    <div className="container">
          <div className="row">
            <div className="col-md-2 col-6">
              <div className="card border-0">
                <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234679/homePage/clientLogo/western_buckland_dt19jn.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234678/homePage/clientLogo/veoc_y61crf.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
              <img src="" data-src="https://res.cloudinary.com/elonatech/image/upload/v1707234699/homePage/clientLogo/pineheight_sljytj.png"  className='img-fluid lazyload' alt="" />
              </div>
            </div>
            <div className="col-md-2 col-6">
              <div className="card border-0">
...
<div className="container">
  <div className="row">
    <div className="col-md-4">
      <div class="mt-5 rounded bg-lazy" style={{backgroundImage:`url(https://res.cloudinary.com/elonatech/image/upload/v1707488914/homePage/main/User_experience_t6dbvw.png)`}}>
        <div class="text-center">
          <p class="p-5 pt-5 pb-5 text-white">We offer bespoke user experience, web design, app design and software development services.</p>
        </div>
      </div>

    </div>
    <div className="col-md-4">
    <div class="mt-5 rounded bg-lazy" style={{backgroundImage:`url(https://res.cloudinary.com/elonatech/image/upload/v1707488913/homePage/main/Solution_client_expectation_doxygk.png)`}}>
     <div class="text-center">
          <p class="p-5 pt-5 pb-5 text-white">We endeavor to exceed our clients’ expectations with the solutions we provide, at competitive prices.</p>
        </div>
      </div>
    </div>
    <div className="col-md-4">
    <div class="mt-5 rounded bg-lazy" style={{backgroundImage:`url(https://res.cloudinary.com/elonatech/image/upload/v1707488915/homePage/main/budget_and_time_xv2dk6.png)`}}>
    <div class="text-center text-white">
          <p class="p-5 pt-5  pb-5">We deliver projects within budget and deadline while continuously maintain  quality & standard. </p>
        </div>
      </div>
    </div>
  </div>
...
<div class="container ">
  <div class="row">
    <div class=" ">
      ...
      <div className="col-md-7 ">
      <div className="mt-5">
        <h3 class="fs-5 mt-5 fw-bold ">How about a FREE Consultation on the Best Digital Marketing Strategy for your Business?</h3> 
        <p className='fs-6 mt-4'>Want to know how to increase your brand visibility, boost audience engagement, drive traffic, increase social media followers, promote your
 ...
 {/* ========================================================== ConsultForm  ===============================================================*/}
<div className="btn btn-danger form-controli btn-md  mt-4 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal2"> Get Free Consultation</div>
{/* ================================================ body  ============================================== */}
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-4 fw-bold text-dark" id="exampleModalLabel">Free Consulting</h1>
      ...
      <form>
            <div class="mb-2 mt-4">
              ...
              <label for="exampleInputEmail1" class="form-label float-start fw-bold  mt-2">Email address<span className='text-danger'>*</span></label>
              <input type="email" class="form-control" onChange={(e) =>  setEmail(e.target.value)} id="exampleInputEmail1" aria-describedby="emailHelp"/>

              <label for="what" class="form-label float-start fw-bold mt-2">What do you do?<span className='text-danger'>*</span></label>
              <input type="text" class="form-control " onChange={(e) =>  setOccupation(e.target.value)} id="what" aria-describedby="whatHelp"/>

              <label for="what" class="form-label float-start fw-bold  mt-2">What challenges do you currently face?<span className='text-danger'>*</span> </label>
              <input type="text" class="form-control" onChange={(e) =>  setChallenge(e.target.value)} id="what" aria-describedby="whatHelp"/>

              <label for="what" class="form-label float-start fw-bold  mt-2">what would you change in your business?<span className='text-danger'>*</span></label>
              <input type="text" class="form-control" onChange={(e) =>  setBusiness(e.target.value)} id="what" aria-describedby="whatHelp"/>

              <label for="what" class="form-label float-start fw-bold mt-2">How much money does it cost you? (In NAIRA)<span className='text-danger'>*</span></label>
              <input  class="form-control" value={cost} onChange={handleChangeCost}  />

              <label for="what" class="form-label  float-start fw-bold mt-2">How much money are you willing to invest? (In NAIRA)<span className='text-danger'>*</span></label>
              <input  class="form-control" value={invest} onChange={handleChangeInvest} />

              <div id="emailHelp" class="form-text mt-2">We'll never share your email with anyone else.</div>
            </div>
          </form>
      </div>
...
<div className="col-md-5  align-self-center">
<div className="">
<img data-src={MDImage} class="lazyload img-fluid mt-2"   alt="" />
</div>
</div>
</div>
</div>
                    ...
                    latestProducts.map((product) => (
                        <div key={product._id} className="col-2 px-1">
                            ...
                            <Link to={`/product/${product._id}`} className='text-decoration-none text-dark d-flex flex-column h-100'>
                                ...
                                <h5 className="fw-normal mt-2 text-truncate" title={product.name}>{product.name}</h5>
                                <p className="small mb-1">{product.category}</p> {/* Display category */}
                                <div className="stars mb-1" style={{color:'#f6b01e'}}>
                                  <i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i><i className="bi bi-star-fill"></i>
                                </div>
                                <div className="d-flex justify-content-between align-items-center mb-2">
