...
/* Section 13 — Your Ignite Outcomes.
   Merges the former "Your Ignite Outcomes" cards with the "What You Receive"
   checklist into a single 8-card set: overlapping items (portfolio,
   leadership, career, industry) are combined; the tangible deliverables
   (certificate, evaluation, SIWES docs, employment consideration) are
   folded in as their own cards. */
const outcomeCards = [
  {
    icon: "bi-cpu",
...
/* Sections 9–12 collapsed into one 4-card section */
const beyondClassroomItems = [
  {
    icon: "bi-person-video3",
    title: "Executive Mentorship",
    desc: "Weekly executive mentorship sessions build professional perspective, confidence, leadership awareness and a clearer understanding of workplace expectations — connecting technical learning with career direction.",
  },
  {
    icon: "bi-robot",
    title: "AI-Integrated Learning",
    desc: "AI is integrated across learning and professional workflows — research, problem-solving, communication, software development, creative production, marketing and data analysis. Participants verify, refine and take responsibility for AI-assisted work.",
  },
  {
    icon: "bi-briefcase",
    title: "Real Industry Exposure",
    desc: "Where appropriate, learning extends beyond the classroom. Participants may receive supervised exposure to selected real-world projects based on demonstrated competence, project availability, confidentiality requirements and Management approval.",
  },
  {
    icon: "bi-file-earmark-text",
    title: "SIWES & Industrial Training Support",
    desc: "Where applicable, Elonatech may serve as the official host organization for SIWES, Industrial Training, Internship or other approved work-integrated learning and complete the relevant institutional documentation. Participants submit required documents promptly and in the required format.",
  },
];
  ...
  return (
    <>
      ...
      <div className="etmpdp-ignite">
          ...
          <div className="container">
            ...
            <div className="emptdp-why-content">
              <div className="emptdp-why-text">
                <p>
                  Industrial training should be more than simply showing up at
                  an office.
                </p>
                <p>
                  ETMPDP Ignite gives undergraduate students a structured
                  environment where they can learn, practice, collaborate,
                  receive mentorship, develop professionally and experience how
                  technology work is actually done.
                </p>
                <p>
                  Whether you're completing SIWES, Industrial Training, an
                  internship or investing in your professional development,
                  Ignite is designed to help you enter the technology industry
          ...
          <div className="container">
            <div className="emptdp-section-header">
              ...
              <p className="emptdp-section-subtitle">
                Develop practical and professional capability around a
                technology direction aligned with your interests, academic
                background and career goals.
              </p>
            </div>

            <p className="ignite-spec-keynote">
              <strong>Key distinction:</strong> Every participant is admitted
              into a primary specialization while benefiting from
              multidisciplinary learning opportunities designed to broaden
              professional competence and industry awareness.
            </p>
        ...
        <section className="emptdp-diff-section">
          <div className="container">
            ...
            <p className="ignite-360-lead">
              Participants in the Six-Month Ignite Executive Track may qualify
              for the Ignite 360&deg; Experience, providing structured
              cross-disciplinary exposure to complementary technology areas.
            </p>

            <p className="ignite-360-lead" style={{ marginTop: "16px" }}>
              Eligible participants may have opportunities to observe,
              collaborate with or undertake selected learning activities across
              complementary specializations based on performance, mentor
              recommendation, operational requirements and Program scheduling.
            </p>
          ...
          <div className="container">
            ...
            <div className="emptdp-mentor-grid">
              ...
              <div className="emptdp-mentor-bio">
                <p className="emptdp-mentor-label">
                  Lead Mentor, ETMPDP Ignite
                </p>
                ...
                <p className="emptdp-mentor-bio-text">
                  With over a decade and a half of industry experience, Oreva
                  has successfully delivered technology solutions across
                  software engineering, networking, IT infrastructure, digital
                  transformation, branding, consulting, business strategy, and
                  executive leadership. Through ETMPDP Ignite, he provides
                  executive mentorship, leadership coaching, career guidance,
                  and professional development to help participants become
                  competent, ethical, and industry-ready professionals.
                </p>
            ...
            {/* Row 2 — Violet (photo right, on a light full-bleed band) */}
            <div className="emptdp-mentor-grid emptdp-mentor-grid--reverse emptdp-mentor-grid--light">
              <div className="emptdp-mentor-photo-col">
                <Link to="/violet-oku">
                  <img
              ...
              <div className="emptdp-mentor-bio">
                ...
                <p className="emptdp-mentor-bio-text">
                  ...
                  control, records management, administration, and
                  organizational support within engineering environments.
                  Through ETMPDP Ignite, she provides guidance in workplace
                  professionalism, administrative practices, employee relations,
                  and organizational effectiveness to help participants become
                  responsible and workplace-ready professionals.
                </p>
            ...
            <div className="emptdp-mentor-grid">
              ...
              <div className="emptdp-mentor-bio">
                ...
                <p className="emptdp-mentor-bio-text">
                  ...
                  testing, and programming instruction. Through ETMPDP Ignite,
                  he provides technical mentorship and practical guidance in
                  software development, emerging technologies, and building
                  scalable, user-focused solutions to help participants become
        ...
        {/* ── 9. Beyond the Classroom (Mentorship · AI · Industry · SIWES) ────── */}
        <section className="emptdp-who-section ignite-tint">
          <div className="container">
            <div className="emptdp-section-header">
              <h2 className="emptdp-section-title">Beyond the Classroom</h2>
              <p className="emptdp-section-subtitle">
                The four things that turn technical skill into industry
                readiness.
              </p>
            </div>
            <CardDeck className="emptdp-diff-grid ignite-how-grid ignite-beyond-grid">
              {beyondClassroomItems.map((c, i) => (
                <div className="emptdp-diff-card" key={i}>
                  <div className="emptdp-diff-icon">
                    <i className={`bi ${c.icon}`}></i>
                  </div>
          ...
          <div className="container">
            <div className="emptdp-section-header emptdp-section-header--light">
              ...
              <p
                ...
                style={{ color: "rgba(255,255,255,0.75)" }}
              >
                The capability you build and the tangible deliverables you
                leave with.
              </p>
            </div>
            <CardDeck
