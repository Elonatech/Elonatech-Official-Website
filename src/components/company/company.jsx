...
<div class="container-fluid our-company-section">
  <div class="text-content">
    ...
    <p class="lead">We apply strategic and result-driven approaches, focused on helping forward thinking businesses succeed</p>
  </div>
</div>
{/*========================================================================== the company ======================================================================*/}
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="section-title position-relative pb-3 mb-">
                        <h2 class="mt-3">The Best Innovative IT Solutions Provider with Over 13 Years of Experience</h2>
                    </div>
                    <p class="mb-4">We, at Elonatech are aware of your current need for quality IT Services.
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-7">
                                       <div className="float-start">
                                        <a href={companyProfilePdf}  class="btn text-white  btn-danger text-start py-3 px-5 mt-3 wow zoomIn"  data-wow-delay="0.9s"><h6>Download Our Company Profile</h6></a>
                                       </div>
...
<div className="container mt-4">
    <div className="row align-items-center">
        ...
        <div className="col-md-6">
            <div className="">
             <p  className="wow fadeInUp"  style={{textAlign:"justify"}} data-wow-delay="0.2s">
             We are pleased to introduce our company, ELONATECH NIGERIA LIMITED, a diversified company in pursuit of excellence in ‘IT’.
             Elonatech Nigeria Limited with RC 1410636 has been in operation for several years as a Computer and Allied products dealer/supplier until much recently in April 2010, where it commenced operations as a One-stop IT Solution Outfit, and was incorporated on May 3rd, 2017.
             ...
             <br />
             We strive to be the leading provider of innovative information technologies that improve the quality of lives. We delight in satisfying our clients through the provision of innovative, quality, timely, relevant, accurate and affordable solutions to their needs.
            </p>
            </div>
            </div>
    </div>
    ...
    <div className="row align-items-center">
        ...
        <div className="col-md-6">
          <div className="text-center">
           <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709823784/groupPicture/the_team_113_ma7z5p.png" className="img-fluid lazyload rounded"    alt="" />
          </div>
        </div>
    </div>
</div>
...
<div className="container rounded wow zoomIn" data-wow-delay="0.9s" style={{backgroundColor:"#000000" , position:"relative" , bottom:"50px"}}>
    ...
    <div className="row ">
        <div className="col-md-4">
            <div className="border-white pt-3">
             <div className="d-flex pt-5 ">
                ...
                <div className="p-1">
                <img src={innovation} className="" loading='lazy'  style={{height:"3rem" , color:"black"}} alt="" />
                </div>
                </div>
        ...
        <div className=" company-professional" style={{ position:"relative" , bottom:"32px"}}>
             <div className="d-flex justify-content-center">
             <div className="border border-primary">
                <div className="p-1">
                <img src={mindset} className=""  loading='lazy' style={{height:"3rem" , color:"black" ,}} alt="" />
                </div>
                </div>
                <h3 className="text-white  ms-4 mt-2">Professionalism</h3>
             </div>
             <p className="text-white company-professionalism-text text-center mt-3 lead fs-6">Providing specialized services with expert solutions</p>
            </div>
        </div>
        ...
        <div className="border-white pt-3">
             <div className="d-flex justify-content-start pt-5 ps-5">
               <div className="border border-primary">
                <div className="p-1">
                <img src={integrity} className="" loading='lazy'  style={{height:"3rem" , color:"black"}} alt="" />
                </div>
                </div>
       ...
       <div className="row company-excellence  mb-5 justify-content-md-center">
            ...
            <div className="">
             ...
             <div className="border border-primary">
                <div className="p-1">
                <img src={commitment} className="" loading='lazy'  style={{height:"3rem" , color:"black"}} alt="" />
                </div>
                </div>
         ...
         <div className="col-md-4 company-team-bord border-start-fg border-top-0 border-bottom-0   border-end-0  " style={{height:"270px"}}>
              <div className=" text-center ">
             <div className="d-flex justify-content-start pt-5 ps-5">
             ...
             <p className="text-white mt-3 ps-5  company-team-text  lead fs-6">Uniting minds together towards a unifying purpose.</p>
            </div>
                </div>
    </div>
