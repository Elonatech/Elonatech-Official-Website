...
<div className='row d-sm-none'>
  <div class='col-lg-3 col-md-5 col-6 footer-info'>
    ...
    <p className=''>4 , Oluwakemi Street, Shasha Road, Egbeda, Lagos.</p>
    <div className=''>
  ...
  <div class='col-lg-2 col-md-3 col-6 footer-links'>
    ...
    <div>
      <ul>
        <li>
          <Link to={'/hardware-engineering'}>Computer Engineering</Link>
        </li>
        <li>
          <Link to={'/network-administration-implementation'}>
            Network Administration
        ...
        <li>
          <Link to={'/application-software'}>Application Software</Link>
        </li>
        <li>
          <Link to={'/web-design'}>Web Design/Dev</Link>
        </li>
