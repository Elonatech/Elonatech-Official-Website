        ...
        <div class="container text-white">
          <div class="row gy-4 d-none d-md-flex">
            <div class="col-lg-3 col-md-5 footer-info">
              ...
              <div class="social-links justify-content-start mt-2 media-icons">
                {/* First Row - 4 Icons */}
                <div class="d-flex justify-content-start">
                  ...
                  <Link
                    ...
                    to={
                      "https://www.linkedin.com/company/elonatech/posts/?feedView=all"
                    }
                  >
                  ...
                  >
                    <i class="bi bi-pinterest social-links-icon"></i>
                  </Link>
                  {/* TikTok Icon */}
                  <Link
                    class="tiktok"
                  ...
                  >
                    <i class="bi bi-tiktok social-links-icon"></i>
                  </Link>
                  {/* Threads Icon */}
                  <Link
                    class="threads"
            ...
            <div class="col-lg-2 col-md-3 footer-links">
              ...
              <div>
                <ul>
                  <li>
                    <Link to={"/who-we-are"}>Our Company</Link>
                  </li>
                  <li>
                    ...
                    <form className="">
                      ...
                      <div class="form-check">
                        <label class="form-check-label" htmlFor="exampleCheck1">
                          ...
                          and
                          <Link className="ps-2 text-white" to={"/terms"}>
                            Terms of Service
