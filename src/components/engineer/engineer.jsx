...
<Helmet>
       ...
       <meta name="description" content="We offer 4 Convenient Computer Repair Options - Pick-up and Return, Onsite Repair, Walk-in and Repair, Remote Support 
       ...
       " />
       <link rel="canonical" href="https://elonatech.com.ng/hardware-engineering" />
</Helmet>
...
<div class="container-fluid hardware-engineering-section">
  <div class="text-content">
    ...
    <p class="lead">While computer hardware configurations vary widely, we work on a broad range of hardware systems</p>
  </div>
</div>
...
<div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={Engineering} className='img-fluid  lazyload' alt="" />
  </div>
      </div>
      <div class="col-md-6">
        <p className=''  style={{textAlign:"justify"}} >
        For specialized hardware services, we have highly skilled full-time computer hardware techs who can fix all
        types of hardware problems including power jacks, keyboards, screens, fans, overheating issues, liquid spills, 
        soldering jobs, loose cabling, and replacement of motherboards and discrete video cards.
        While computer hardware configurations vary widely, we work on a broad range of hardware systems.
        </p>
...
<div class="col-md-5">
<div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={Repair} className='img-fluid mt-2 mb-2  lazyload' alt="" />
  </div>
</div>
</div>
</div>
...
<div class="col-md-5">
<div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif' data-src={Repair2} className='img-fluid mt-2 mb-2  lazyload' alt="" />
  </div>
</div>
<div class="col-md-6 mt-2">
<h4 className='fw-bold'>We offer 4 Convenient Computer Repair Options</h4>
<ul className='list-unstyled '>
<li className='kos'><i class="bi bi-check-square  me-3"></i>Pick-up and Return</li>
<li className='kos'><i class="bi bi-check-square  me-3"></i>Onsite Repair</li>
<li className='kos'><i class="bi bi-check-square  me-3"></i>Walk-in and Repair</li>
<li className='kos'><i class="bi bi-check-square  me-3"></i>Remote Support</li>
</ul>
