    ...
    <>
      ...
      <div className="container mt-5">
        <p className="fs-1 fw-bolder" style={{ color: "#34548c" }}>
          Over a Decade and a Half of Excellence in Innovation
        </p>
        <div className="row">
          <div className="col-md-12">
            <p className="" style={{ textAlign: "justify" }}>
              Elonatech Nigeria Limited began operations several years ago as a
              supplier of computer and allied products. In April 2010, the
              company evolved into a{" "}
              <strong>one-stop IT solutions outfit</strong> and was officially
              incorporated on <strong>May 3rd, 2017 (RC 1410636)</strong>. Since
              then, Elonatech has grown into a trusted technology partner to
              organizations across Nigeria, bridging the gap between people,
              process, and performance. <br />
              Our services are tailored for top-tier corporate clients, focused
              on innovation, reliability, and long-term value. At Elonatech, we
              constantly evolve to meet the dynamic needs of a technology-driven
              world.
            </p>
          </div>
        </div>
