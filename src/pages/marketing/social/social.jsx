              ...
              <ul className='list-unstyled mt-3'>
                <li>
                  <div className='d-flex align-items-center'>
                    ...
                    <p className='ms-2 mb-0'>Increase brand awareness</p>
                  </div>
                </li>
                <li>
                  <div className='d-flex align-items-center mt-2'>
                    <i class='bi bi-check-circle-fill fs-4'></i>
                    <p className='ms-2 mb-0'>Build engaged communities</p>
                  </div>
                </li>
                <li>
                  <div className='d-flex align-items-center mt-2'>
                    <i class='bi bi-check-circle-fill fs-4'></i>
                    <p className='ms-2 mb-0'>Sell products and services</p>
                  </div>
                </li>
                <li>
                  <div className='d-flex align-items-center mt-2'>
                    <i class='bi bi-check-circle-fill fs-4'></i>
                    <p className='ms-2 mb-0'>Measure brand sentiment</p>
                  </div>
                </li>
                <li>
                  <div className='d-flex align-items-center mt-2'>
                    <i class='bi bi-check-circle-fill fs-4'></i>
                    <p className='ms-2 mb-0'>Provide social customer service</p>
                  </div>
                  <div className='d-flex align-items-center mt-2'>
                    <i class='bi bi-check-circle-fill fs-4'></i>
