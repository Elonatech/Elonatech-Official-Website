...
<Helmet>
       ...
       <meta name="description" content="Compared to traditional marketing, social media posts by businesses can be seen by followers across geography within seconds. This offers a somewhat level playing field as you can then have a global approach to your business. 
       ...
       " />
       <link rel="canonical" href="https://elonatech.com.ng/social-media-marketing" />
</Helmet>

 {/*========================================================================================================================= */}
 <div class="container-fluid social-media-marketing-section">
  <div class="text-content">
    <h2>Social Media Marketing</h2>
    <h5>The Tools You Need to Grow Your Business</h5>
...
<div className="container mb-5 mt-5">
  <div className="row g-0">
    <div className="col-md-6">
      ...
      <img   data-src="https://res.cloudinary.com/elonatech/image/upload/v1709660673/socialPage/Social-Media-Marketing_jh9suk.jpg" className="img-fluid lazyload " style={{height:"23.6rem"}} />
      </div>
    </div>
    <div className="col-md-6">
        ...
        <div class="row justify-content-between mb-5 align-items-center">
          <div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
            <div class="img-about dots text-center">
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709660670/socialPage/social-media-marketing-fundamentals_dktk73.png" alt="Image" class="img-fluid lazyload" />
            </div>
          </div>
          <div class="col-lg-5">
