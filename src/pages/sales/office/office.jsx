...
const Office = () => {
  ...
  useEffect(() => {
    const returningUser = localStorage.getItem("OfficePopUp");
    if (!returningUser) {
      toast.warn(
...
<div class="container-fluid office-equipment-section">
  <div class="text-content">
    <h2>Office Equipment</h2>
    <h5>Do twice as much work simultaneously with quality office equipment</h5>
    <p class="lead">Increase productivity and the overall operating speed of your office operations and staff overall performance.</p>
  </div>
</div>
              ...
              >
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <Link
                      to={"/office-equipment"}
                      className={`item ${activeItem === "Item 3" ? "active-category" : ""}`}
