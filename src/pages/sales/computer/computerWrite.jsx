...
<div className="row">
 ...
 <div className="row">
            <div className="col-md-6 mt-2 mb-3">
                ...
                <input type="text" id="price" class="form-control" onChange={(e) => setOdd(e.target.value)}  name="price" placeholder="Enter price" ></input>  
            </div>
            <div class=" col-md-6 mb-3 ">
             <label for="exampleInputEmail1" class="form-label fw-bold">Quantity</label>
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder='Brand Name' onChange={(e) => setQuantity(e.target.value)}  aria-describedby="emailHelp"  />
            </div>
            </div>
{/*  */}
