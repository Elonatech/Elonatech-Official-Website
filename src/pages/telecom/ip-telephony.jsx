...
<Helmet>
       <title>IP Telephony & PBX Systems - Tech Solution, Digital Solution</title>
       <meta name="description" content="IP Telephony & PBX Systems
...
<div class="container-fluid ip-telephony-section">
  <div class="text-content">
    ...
    <p class="lead">VoIP feature that greets callers, directs them to the appropriate extensions or departments, and assists in managing incoming calls with efficiency and professionalism.</p>
  </div>
</div>
...
<div className="container" style={{marginTop:"100px"}}>
  <div class="row justify-content-center align-items-center g-2">
    ...
    <div class="col-md-6">
      ...
      <img src='https://i.stack.imgur.com/qq8AE.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709648752/IPTelephonyPage/phone-network_xiocp0.jpg" alt="" className='img-fluid lazyload rounded' />
      </div>
    </div>
  </div>
</div>
...
<div className="container">
  ...
  <div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709648863/IPTelephonyPage/meetings_phone_chat_img_hfxyqd.jpg" alt="" className='img-fluid lazyload rounded' />
      </div>
    </div>
