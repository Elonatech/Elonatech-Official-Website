...
<Helmet>
       ...
       <meta name="description" content="Flexible VoIP Phone Systems
...
{/*===================================================================== header =================================================*/}
<div class="container-fluid voip-section">
  <div class="text-content">
    <h2>Voice Over Internet Protocol (VoIP)</h2>
    <h5>Transforming your Communication</h5>
    <p class="lead">Cut cost, improve remote collaboration and increase efficiency. Everything's going digital, traditional phone lines are going away.</p>
  </div>
</div>
...
<div className="container  mb-5" style={{marginTop:"100px"}}>
  <div class="row justify-content-center align-items-center  g-2">
    ...
    <div class="col-md-6">
      ...
      <img src='https://i.stack.imgur.com/qq8AE.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709648091/voipPage/voip-image_yipevc.jpg" alt="" className='img-fluid lazyload rounded' srcset="" />
      </div>
    </div>
  </div>
</div>
...
<div className="container  mb-5" style={{marginTop:"100px"}}>
  ...
  <div class="col-md-6">
  <div className="text-center">
      <img src='https://i.stack.imgur.com/qq8AE.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709648126/voipPage/call-center_fb1qzk.jpg" alt="" className='img-fluid lazyload rounded' srcset="" />
      </div>
    </div>
    <div class="col-md-6 ps-5">
