...
<Helmet>
       ...
       <meta name="description" content="At Elonatech we take pride in providing secure, reliable & affordable Domain Registration to all our clients. That is why we offer the best industry prices not only for new domains registered with us but also for Domain Renewals & hassle free Domain Transfers to us.
...
<div class="container-fluid domain-registration-section">
  <div class="text-content">
    ...
    <h5>Everything You Need To Succeed Online, It All Starts with a Great Domain</h5>
    <p class="lead">Get your website online today! Register .com.ng, .ng Domains and Get Free DNS & Email Hosting.</p>
  </div>
</div>
...
{/*=================================================================== domain ===============================================================*/}
                        ...
                        <p className=''>The right domain name goes a long way. Expect greater traction with your target audience, a unique online presence and your own identity in an ever-growing market. Find your perfect domain now.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="col-md-6">
      <div className="mt-4">
        <p className=''>
         ...
         <div className="col-md-6">
        <div className="text-center">
        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709647317/domainPage/domain-1-removebg-preview_zveocr.png" className='lazyload img-fluid me-3' alt="" />
        </div>
      </div>
  </div>
</div>
...
<div className="container mt-5">
    ...
    <div className="row">
        ...
        <div className="ms-5">
           ...
           <p className='ms-5'>Manage domain registrant, admin, and technical contacts. <br /> Change them, execute trade or transfers, and update contact <br /> details in bulk.</p>
        </div>
        </div>
        <div className="col-md-6">
        <div className="ms-5">
           ...
           <p className='ms-5'>Your domain will always be registered under your own name. <br /> No compromises  or  losing it in the future</p>
        </div>
        </div>
        <div className="col-md-6">
        <div className="ms-5">
           ...
           <p className='ms-5'>Privacy is paramount to us, so full WHOIS privacy protection is included <br /> and enabled as a standard at no extra cost.</p>
        </div>
        </div>
        <div className="col-md-6">
        <div className="ms-5">
           ...
           <p className='ms-5'>No stealth fees for transferring out. Generate your authorization <br /> codes and  lock your domain via our control panel.</p>
        </div>
        </div>
    </div>
</div>
...
<section class="choose-plan-section" style={{marginTop:"80px"}}>
        <div class="container">
            <div class="row">
                ...
                <div className="text-center">
                   <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709647318/domainPage/choose-plan_sqw915.png" className='lazyload img-fluid me-3' alt="" />
               </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="plan__text">
                        ...
                        <ul className='list-unstyled'>
                            <li><span class="fa fa-check me-3 text-danger"></span>Free DNS Management</li>
                            <li><span class="fa fa-check me-3 text-danger"></span>Multiple Year Discount</li>
                            <li><span class="fa fa-check me-3 text-danger"></span>Free Renewal With Transfer</li>
                            <li><span class="fa fa-check me-3 text-danger"></span>Instant Activation</li>
                            <li><span class="fa fa-check me-3 text-danger"></span>Registrar Lock</li>
                            <li><span class="fa fa-check me-3 text-danger"></span>Over 400 Domain Extensions</li>
                        </ul>
                    </div>
                </div>
            </div>
