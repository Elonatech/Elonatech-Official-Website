...
const SystemSoftware = () => {
    return (
        ...
        <meta name="description" content="How System Software works?
...
System software is the most important software in a computer, it enables other software to run properly, by interfacing with hardware and software; and drivers which is responsible for every part of a computer to work and function properly. " />
        ...
        <div class="container-fluid system-software-section">
          <div class="text-content">
            ...
            <h5>Computer program designed to run a computer’s hardware and application programs</h5>
            <p class="lead">Minimizing downtimes while maximizing reliability in order to meet the needs of organizations over time.</p>
          </div>
        </div>
          ...
          <div class="row justify-content-center align-items-center  g-4">
            ...
            <div class="col-md-6">
                <div className="text-center">
                     <img src='https://i.stack.imgur.com/qq8AE.gif' className='img-fluid rounded lazyload'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652504/systempage/system-software1_dwwxyj.png" alt=""    />
                </div>
            </div>
          </div>
        </div>
                ...
                <div class="tab-content">
                  <div class="tab-pane active show" id="tab-1">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652758/systempage/program_translation_2_n1dsur.png" alt="" class="img-fluid lazyload"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="tab-2">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652753/systempage/operating-system-structure_crv0hm.png" alt="" style={{height:"19rem"}} class="img-fluid lazyload"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="tab-3">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652747/systempage/Device_driver30ac685128a8498ca455a6908da1dda9_vfxx0z.webp" alt="" class="img-fluid lazyload"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="tab-4">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652750/systempage/firmware_ruhcau.png" alt=""  style={{height:"18rem"}} class="img-fluid lazyload"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="tab-5">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709652745/systempage/bios-vs-uefi_dybm2f.jpg" class="img-fluid lazyload"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="tab-pane" id="tab-6">
                    <div class="row gy-4">
                      ...
                      <div class="col-lg-4 order-1 order-lg-2 text-center">
                        <img src="https://res.cloudinary.com/elonatech/image/upload/v1709652741/systempage/Utility-System-Software-1024x576_bp1ytq.webp" alt="" class="img-fluid"/>
                      </div>
                    </div>
                  </div>
                </div>
