...
const Video = () => {
  ...
  return (
    ...
    <Helmet>
       ...
       <meta name="description" content="We provide comprehensive video and photography solutions for events of every size, anywhere in Nigeria. 
...
{/*========================================================================== header ==========================================================*/}
<div class="container-fluid video-editing-section">
  <div class="text-content">
    <h2>Video Editing</h2>
    <h5>Putting together, cleaning up and finalizing a video output</h5>
    <p class="lead">We provide comprehensive video and photography solutions for events of every size, anywhere in Nigeria. Whether it’s a conference, training, presentation, exhibitions etc</p>
  </div>
</div>
...
<img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721186/VideoEditingPage/editing_tvderp.png" className="lazyload img-fluid" />
</div>
</div>
</div>
<div class="col-md-6">
...
We provide comprehensive video and photography solutions for events of every size, anywhere in Nigeria. Whether it’s a conference, training, presentation, exhibitions etc.
 ...
 <div className="container">
      <div className="row align-items-center">
        <div className="col-md-6 mb-5">
                  ...
                  Creating videos often involves recording and then compiling multiple shots to create a unique video. 
                  Video editing is the post-production process, which may involve rearranging clips, creating transitions, correcting color, adding audio, and 
                  adding titles and subtitles. It is a visual art. <br /> <br /> The goal of video editing is to choose the best clips, create a cohesive flow, 
                  and add effects to tell the story you want to tell in a way that engages the viewer.  Likewise, to manipulate these events to bring the communication 
                  closer to the original goal or target.
                  </p>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="card border-0">
                  <div className="text-center">
                        <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721187/VideoEditingPage/video_z0jhlg.png" class="img-fluid lazyload" />
                  </div>
                  </div>
                </div>
              </div>
...
<div className="container">
              <div className="row align-items-center">
                <div className="col-md-6">
                  ...
                  <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1710316557/VideoEditingPage/Video_editing_2_ssge3i.jpg" class="img-fluid lazyload" alt="..." />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="card border-0">
  ...
  <div class="container mt-5">
          ...
          <h2 className=' fw-bold'>Video Production to the <br /> Next Level</h2>
            ...
            <div class="row">
              ...
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721966/VideoEditingPage/png-transparent-board-clapper-cut-director-making-movie-take-the-movies-icon_utwhix.png" alt="" className='image-icon lazyload'/>
              <div class="card-body">
              ...
              <div class="col-md-4 mt-4">
              <div class="card h-100" style={{width:"23rem"}} >
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721963/VideoEditingPage/download_1_n6f85z.png" alt="" className='image-icon lazyload'/>
              <div class="card-body">
              ...
              <div class="col-md-4 mt-4">
              <div class="card h-100" style={{width:"23rem"}}>
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709722077/VideoEditingPage/974485_el8btv.png" alt="" className='image-icon lazyload'/>
              <div class="card-body">
...
<div class="container mt-4 mb-5">
            <div class="row">
              <div class="col-md-4 mt-4" >
              <div class="card h-100" style={{width:"23rem"}}>
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721962/VideoEditingPage/png-transparent-volume-icon-volume-computer-icons-sound-icon-volume-miscellaneous-text-hand-thumbnail_b0mafu.png" alt="" className='image-icon lazyload'/>
              <div class="card-body">
              ...
              <div class="col-md-4 mt-4" >
              <div class="card h-100" style={{width:"23rem"}}>
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709722151/VideoEditingPage/7602189_tfynou.png" alt="" className='image-icon lazyload img-fluid'/>
              <div class="card-body">
              ...
              <div class="col-md-4 mt-4" >
              <div class="card h-100" style={{width:"23rem"}}>
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709721961/VideoEditingPage/convert-video-icon-design-isolated-260nw-2179748723_daxp2m.jpg" alt="" className='image-icon lazyload img-fluid'/>
              <div class="card-body">
