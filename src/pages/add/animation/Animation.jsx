...
function Animation() {
  return (
    ...
    <Helmet>
       ...
       <meta name="description" content="We Have All You Need For Your Animation.....
...
<div class="container-fluid animations-section">
  <div class="text-content">
    <h2>Animations</h2>
    <h5>Creating engaging and immersive animations is a dynamic and captivating way to bring your ideas to life.</h5>
    <p class="lead">Animations have the power to convey complex concepts, evoke emotions, and leave a lasting impression on your audience.</p>
  </div>
</div>
...
<div class="row">
          <div class="col-md-6">
          <img src="https://res.cloudinary.com/elonatech/image/upload/v1709645935/2dAnimationPage/animation_111_720_aoesan.png" alt="" style={{marginBottom:'100px'}}  className='mb-2 img-fluid'/>
          </div>
          <div class="col-md-6">
...
<div className="row g-0">
            <div className="col-md-6">
              ...
              <img src="https://res.cloudinary.com/elonatech/image/upload/v1709645939/2dAnimationPage/animation_jeperf.jpg" alt="img-fluid lazyload rounded" style={{height:"35rem"}} />
              </div>
            </div>
            <div className="col-md-6">
              <div className=" text-black align-items-center faq" >
              <h2 class="font-weight-bold heading p-2 pt-3 ps-5  fw-bold pl-2">FAQs</h2>
