...
<Helmet>
  ...
  {/* header */}
  <div class="container-fluid brand-development-section">
  <div class="text-content">
    <h2>Brand Development</h2>
    <h5>It’s much more than a logo, it's actually at the intersection of strategy and design</h5>
    <p class="lead">“A Brand Is No Longer What We Tell The Consumer It Is - It Is What Consumers Tell Each Other It Is.” – <span>SCOTT COOK</span></p>
  </div>
</div>
 ...
 <div className="container mt-5" >
          ...
          <div class="row justify-content-evenly gx-4 mt-5 align-items-center">
            ...
            It’s much more than a logo, Elonatech brand identity development service is actually at the intersection of strategy and design.</p>
              ...
              <div class=" col-md-6">
              <img src="https://res.cloudinary.com/elonatech/image/upload/v1709661458/brandingPage/branding_hlrwz8.png" class="img-fluid rounded " alt="" />
              </div>
            </div>

            <div class="row justify-content-evenly mt-4  flex-column-reverse flex-lg-row">
              <div class="col-md-6">
                <img src="https://res.cloudinary.com/elonatech/image/upload/v1710315652/brandingPage/brandin_2_aj6mxs.jpg" class="img-fluid rounded" alt="" />
              </div>
              <div class="col-md-6 ">
                <h4 className='text-danger fw-bold  pb-2'>Why Does Brand Identity Matter?</h4>
                <p className='text-justify'> Brand identity matters because without it, customers are not able to recognize a brand easily. A strong brand may helps sell a company to consumers. <br /> <br />

                <h4 className='text-danger fw-bold pb-2'>What Makes a Good Brand? </h4>
 ...
 <div class="carousel-indicators">
  ...
  <div class="carousel-inner">
    <div class="carousel-item   active">
      <img src="https://res.cloudinary.com/elonatech/image/upload/v1709661554/brandingPage/elona_sationaries_brand_wvtpjy.jpg" class="d-block w-100 " alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="https://res.cloudinary.com/elonatech/image/upload/v1710315639/brandingPage/Remaben_brand_vwwd8m.jpg" class="d-block w-100 " alt="..."/>
    </div>
    <div class="carousel-item">
      <img src="https://res.cloudinary.com/elonatech/image/upload/v1710315639/brandingPage/safebrooks_fupkl3.jpg" class="d-block w-100 " alt="..."/>
    </div>
  </div>
     ...
     <h5 className="text-center FAQ pb-5" style={{color:"#2b5592", fontWeight:"800"}}> Some Of Our Clients</h5>
      ...
      <div>
              <Slider {...settings} style={sliderStyle}>
                  <div>
                    {/* safebrooks */}
                    <h3><img src={Client1} alt="" style={{height:"60px", width:"60px"}}  className='clients'/></h3> 
                  </div>
                  <div>
                  ...
                  <div>
                    {/* pencostal */}
                    <h3><img src={Client4} alt="" style={{height:"60px", width:"60px"}}   className='clients'/></h3>
                  </div>
                  <div>
                  ...
                  <div>
                    {/* round */}
                    <h3><img src={Client6} alt="" style={{height:"60px", width:"60px"}}   className='clients'/></h3>
                  </div>
                  <div>
...
<div class="accordion-item">
  ...
  <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
    <div class="accordion-body">
    Branding is the process of creating a brand. It is important as it involves clearly positioning your company or product in the market, devising a brand strategy,
     possibly creating your name, defining your company’s tone of voice and designing corporate and/or product identity.
        Using water as an example, how do several companies around the world sell the same product and convince the market to purchase their water over their
         competitors? The simple answer: a great brand!
    </div>
  </div>
</div>
...
<div class="accordion-item">
  ...
  <div id="faq-content-4" class="accordion-collapse collapse" data-bs-parent="#faqlist">
    <div class="accordion-body">
    Ummm….no! Remember, a brand is much more than just a logo. It is the story, look and voice of a brand. <br />
    ...
    So, if you put all this in perspective, you can see how getting a logo for #5000 on Fiverr, won’t really provide the full brand story for your business.
...
<div class="accordion-item">
  ...
  <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
    <div class="accordion-body">                     
    A successful brand pays attention to their market, will come up with new ways to keep the interest of their target market and are not afraid to innovate. <br /> <br />
