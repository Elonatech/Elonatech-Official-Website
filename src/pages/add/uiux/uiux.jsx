...
const Uiux = () => {
  return (
    ...
    <Helmet>
       ...
       <meta name="description" content="Crafted to elevate your digital presence, captivate your audience, and drive exceptional user engagement 
...
{/*======================================================= header =====================================================*/}
<div class="container-fluid ui-ux-section">
  <div class="text-content">
    <h2>User Interface and User Experience</h2>
    <h5>Elevate Your Digital Experience: Unleash the Power of UI/UX</h5>
    <p class="lead">Crafted to elevate your digital presence, captivate your audience, and drive exceptional user engagement.</p>
  </div>
</div>
      ...
      <div className="row align-items-center">
        <div className="col-md-6">
          <div className="text-center">
             <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718062/uiuxPage/safebrooks-uiux_me4g7t.png" alt=""  className='img-fluid lazyload rounded'/>
          </div>
        </div>   
      <div className="col-md-6 ">
...
<div className="container  justify-content-around mb-5" >
        ...
        <div class="row">
            ...
            <div class="p-3 mb-2  text-center">
              <img src='https://i.stack.imgur.com/qq8AE.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718055/uiuxPage/ui-1_w6pfok.png" className='lazyload' style={{width:"100px"}} alt=""/>
              </div>
                ...
                <div class="p-3 mb-2  text-center"> 
                <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718046/uiuxPage/ui-2_fwa5wv.png" className='lazyload' style={{width:"100px"}} alt=""/>
                </div>
                ...
                <p className='text-center fs-6'> Crafting intuitive navigation and content hierarchy to ensure users find what they need effortlessly.</p>
                 ...
                 <div class="col-md-4  mt-3" data-aos="zoom-in" data-aos-duration="3000"><div className="">
                  <div class="p-3 mb-2  text-center"> 
                  <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718047/uiuxPage/ui-3_ypwcpt.png" className='lazyload' style={{width:"100px"}} alt=""/>
                  </div>
                ...
                <div class="col-md-4  mt-3" data-aos="zoom-in" data-aos-duration="1000"><div className="">
                  <div class="p-3 mb-2  text-center">
                    <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718052/uiuxPage/ui-4_pp9bfa.png" className='lazyload' style={{width:"100px"}} alt=""/>
                  </div>
                ...
                <p className='text-center fs-6'>From responsive web design to app interfaces, our designs prioritize the user's experience at every touchpoint.</p>
                  ...
                  <div class="col-md-4  mt-3" data-aos="zoom-in" data-aos-duration="2000"><div className="">
                  <div class="p-3 mb-2  text-center">
                    <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718053/uiuxPage/ui-5_or8mms.png" className='lazyload' style={{width:"100px"}} alt=""/>
                  </div>
                 ...
                 <div class="col-md-4  mt-3" data-aos="zoom-in" data-aos-duration="3000"><div className="">
                  <div class="p-3 mb-2  text-center">
                    <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718054/uiuxPage/ui-6_onu1jn.png" className='lazyload' style={{width:"100px"}} alt=""/>
                  </div>
        ...
        <div className="row g-0 align-items-center">
          <div className="col-md-6">
            <div className="card border-2 rounded-0" style={{borderColor:"#016193"}}>
              <div className="text-center">
              <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709718589/uiuxPage/remaben_khx8gx.png" className='img-fluid lazyload' alt="" style={{height:"23.9rem",  }} />
              </div>
            </div>
          </div>
          <div className="col-md-6">
