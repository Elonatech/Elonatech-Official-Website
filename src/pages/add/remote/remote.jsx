...
<Helmet>
       ...
       <meta name="description" content="Remote Support is the ability to remotely access and control a computer or mobile device anytime, anywhere using a reliable and secure remote support software. 
...
<div class="container-fluid remote-support-section">
  <div class="text-content">
    ...
    <h5>Access to Experts offering Round-the-Clock maintenance aimed at Increasing productivity</h5>
    <p class="lead">Remotely accessing and controlling computers or mobile devices anytime, anywhere using reliable and secure remote connections</p>
  </div>
</div>
        ...
        <div class="row justify-content-center mt-5 align-items-center">
            ...
            <div class="col-md-6 pr-md-2" >
              <div className="text-center">
                  <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715682/remoteSupportPage/image-asset-removebg-preview_kox026.png" alt=""  className='img-fluid lazyload'/>
              </div>
            </div>
           </div>
        <div className="pt-5">
            <div class="row justify-content-center flex-column-reverse flex-lg-row align-items-center" >
                ...
                <div className="text-center">
                  <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715683/remoteSupportPage/african-woman-sitting-computer-science-class-lady-with-glasses-female-student-sitting-computer_1157-42317_p3stwn.jpg"  className='img-fluid lazyload'/>
                </div>
                </div>
                <div class="col-md-6" >
            ...
            <div class="row  justify-content-center ">
                <div class="col-md-3 mt-4" data-aos="zoom-out-right" data-aos-duration="1000">
                    <div class="card h-100 ">
                        <img src='https://res.cloudinary.com/elonatech/image/upload/v1710164778/loaderImage/Loading_icon_wrnmya.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715713/remoteSupportPage/cost-reduction-business-concept-finance_220873-30348_xxdwmd.jpg" alt="" className="img-fluid lazyload" />
                        <div class="card-body">
                ...
                <div class="col-md-3 mt-4" >
                    <div class="card h-100">
                        <img src='https://res.cloudinary.com/elonatech/image/upload/v1710164778/loaderImage/Loading_icon_wrnmya.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715713/remoteSupportPage/sand-running-through-bulbs_488220-37412_x9ry16.jpg" alt="" className="img-fluid lazyload" />
                        <div class="card-body">
                ...
                <div class="col-md-3 mt-4">
                    <div class="card h-100">
                       <img src='https://res.cloudinary.com/elonatech/image/upload/v1710164778/loaderImage/Loading_icon_wrnmya.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715739/remoteSupportPage/human-resources-concept-with-man_r1xgau.jpg" alt=""  className="img-fluid lazyload"/>
                        <div class="card-body">
                ...
                <div class="col-md-3 mt-4">
                    <div class="card h-100">
                       <img src='https://res.cloudinary.com/elonatech/image/upload/v1710164778/loaderImage/Loading_icon_wrnmya.gif'  data-src="https://res.cloudinary.com/elonatech/image/upload/v1709715740/remoteSupportPage/top-view-tools-clockwork-spare-parts_696657-21926_rqvdlw.jpg" alt=""  className="img-fluid lazyload"/>
                        <div class="card-body">
...
<div className="mt-5" style={{backgroundColor:"#34548c"}}>
          ...
          <div class="row">
              ...
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709716548/remoteSupportPage/teleworking_puzpx1.png" alt="" className='photo-icon lazyload'/>
              <div class="card-body">
              ...
              <div class="card remote-card h-100" style={{width:"23rem"}} >
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709716548/remoteSupportPage/sharing_d1odru.png" alt="" className='photo-icon lazyload'/>
              <div class="card-body">
                <h5 className='fw-bold'>Screen sharing</h5>
                <p class="card-text p-1 text">
                  Screen sharing assist enables quick and secure screen sharing so technicians can share their computer screen with remote end users. Technicians can use this feature to provide a demonstration when required.
                </p>
              </div>
            </div>
              </div>
              ...
              <div class="card remote-card h-100" style={{width:"23rem"}}>
              <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709716547/remoteSupportPage/remote-access_vfvnhv.png" alt="" className='photo-icon lazyload'/>
              <div class="card-body">
                <h5 className='fw-bold'>Unattended Remote Access</h5>
                <p class="card-text  p-1 text">Unattended remote access is access to a remote computer without any person at the remote end. With unattended access, issue resolution, patch, software updates, and a whole lot of other activities can be achieved in a customer's idle time without asking them to take time out of their workday for the session.</p>
              </div>
            </div>
            </div>
            </div>
