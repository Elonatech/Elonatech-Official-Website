...
<Helmet>
       ...
       " />
       <link rel="canonical" href="https://elonatech.com.ng/motion-graphics" />
</Helmet>

{/*========================================================= header ===================================================*/}
<div class="container-fluid motion-graphics-section">
  <div class="text-content">
    <h2>Motion Graphics</h2>
    <h5>A style of animation that combines graphic design and visual effects into engaging visuals.</h5>
    <p class="lead">Used in various media to convey information, make presentations, tell stories, or enhance the overall viewing experience.</p>
  </div>
</div>
...
<div className="container">
    ...
    <div class="col-md-6">
          ...
          <p className='b-4'>Choosing the right partner for your motion graphics project is crucial. At Elonatech, we offer:</p>
          <ul className='list-unstyled'>
            <li className='pb-2'><b>Creative Excellence: </b> Our team of talented artists and animators ensures your content is visually stunning and impactful.</li>
            <li className='pb-2'><b>Custom Solutions: </b>  Every project is unique, and we tailor our services to match your specific goals</li>
            <li className='pb-2'><b>Timely Delivery: </b>  We understand the importance of deadlines and strive to deliver on time, every time.</li>
            <li className='pb-2'><b>Collaborative Approach: </b>   We work closely with you throughout the process to ensure your vision is realized.</li>
            <li className='pb-2'><b>Competitive Pricing: </b>  High-quality motion graphics don't have to break the bank. We offer cost-effective solutions.</li>
          </ul>
      </div>
</div>
<div className=" pt-5">
            <h3 className='text-center fw-bold'>Get Started</h3>
            <h4 className='text-center mb-4' style={{color:"rgb(52,84,140)"}}>Let's Create Something Extraordinary Together</h4>
            <p className='text-center  pb-2'>Motion graphics have the power to turn your content into a visual masterpiece that resonates with your audience. Whether you're looking to educate, entertain, or inspire, motion graphics can help you achieve your goals. Contact us today to start your journey toward visual excellence.</p>

</div>
</div>
{/* ==================================================================================================================== */}
<div class="p-3 text-white align-middle mt-2" style={{background:"rgb(52,84,140)"}}>
          <div class="row  pb-2">
...
<div className="container">
  <div class="row justify-content-around mt-5 align-items-center mb-5">
        <div class="col-md-6 pt-4">
          ...
          <p className=''>At Elonatech, we specialize in creating stunning motion graphics tailored to your unique needs. Our team of skilled artists and animators collaborates closely with you to bring your vision to life. Our services include:</p>
          <ul className='list-unstyled'>
            <li className='pb-2'> <b>Explainer Videos: </b>  Simplify complex ideas and engage your audience.</li>
            <li className='pb-2'> <b>Brand Promotion: </b>  Elevate your brand with visually appealing content.</li>
            <li className='pb-2'> <b>Product Showcase: </b>  Highlight your products with dynamic animations.</li>
            <li className='pb-2'> <b>Data Visualization: </b>  Make data more accessible and compelling.</li>
            <li className='pb-2'> <b>Interactive Experiences: </b>  Engage your audience with interactive motion graphics.</li>
        </ul>
        </div>
          <div class="col-md-6">
