...
<Helmet>
    ...
    <meta name="description" content="Our Technical Support Team
is composed of individuals that are familiar with the ins and outs of the device they are assigned to. They offer user-friendly assistance for individuals having technical problems with computer/electronic devices. With this knowledge, they are able to troubleshoot most problems that a user experiences. Technical support may be provided over the phone, through email, a live-chat interface or with a remote support solution." />
    <link rel="canonical" href="https://elonatech.com.ng/technical-support" />
</Helmet>
...
<div class="container-fluid tech-support-section">
  <div class="text-content">
    <h2>Tech Support</h2>
    <h5>To ensure that customers can effectively use products or services without facing technical hurdles.</h5>
    <p class="lead">We provide assistance to customers and clients who are experiencing technical issues with products, services, or equipment.<br />Offering guidance on the use of software or hardware, and resolving any issues that arise.</p>
  </div>
</div>
        ...
        <div className="container pb-5">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-6"   >
                    <div className="text-center">
                          <img src='https://i.stack.imgur.com/qq8AE.gif' data-src="https://res.cloudinary.com/elonatech/image/upload/v1709717198/techSupportPage/fixing-server_wrgsqu.jpg" alt="" className='img-fluid rounded lazyload'/>
                    </div>
                </div>
            </div>
            </div>
        ...
        <div className="container p-1 mb-5" style={{backgroundColor:"#34548c"}}>
            <div className="text-light">
            <h3 className='fw-bold text-center mt-3'>Typical Technical Support responsibilities include:</h3>
            <div class="row justify-content-center  pt-4">
                <div class="col-md-6">
                <ul style={{ listStyle:"none"}} >
                    <li className='pl-1'>
                        <div className="d-flex ">
                            <img data-src="https://res.cloudinary.com/elonatech/image/upload/v1709717145/techSupportPage/star_vwt9yq.png" alt="" className='star me-3 lazyload'/>
