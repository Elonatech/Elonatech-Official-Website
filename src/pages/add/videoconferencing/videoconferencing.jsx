...
<link rel="canonical" href="https://elonatech.com.ng/videoconferencing" />
</Helmet>

{/*====================================================================== header ====================================================*/}
<div class="container-fluid videoconferencing-section">
  <div class="text-content">
    <h2>Videoconferencing</h2>
    <h5>Helping People Connect, Regardless of Where They’re Located.</h5>
    <p class="lead">This is an online technology that allows users in different locations to hold face-to-face meetings without having to move to a single location together</p>
  </div>
</div>
        ...
        <div class="row justify-content-center mt-4 mb-4 align-items-center">
          <div class="col-md-6">
            <div className="text-center">
                <img src="https://i.stack.imgur.com/qq8AE.gif" data-src="https://res.cloudinary.com/elonatech/image/upload/v1709724222/videoConferencingPage/meeting-room_quurwd.jpg" alt="" className='img-fluid lazyload rounded' />
            </div>
          </div>
...
<div className="" style={{backgroundColor:"#34548c", marginTop:"5rem"}}>
        ...
        <div class="row justify-content-center py-5 align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-up">
            <div className="text-center">
             <img src="https://i.stack.imgur.com/qq8AE.gif" data-src="https://res.cloudinary.com/elonatech/image/upload/v1709724223/videoConferencingPage/recordvideo_krq3kg.jpg" alt="" className='img-fluid lazyload pt-2 pt-md-0'/>
            </div>
          </div>
        </div>
        </div> 
...
<div className="container" >
          <div class="row align-items-center my-5 align-items-center">
            ...
            <div class="col-md-4" data-aos="fade-up">
              ...
              <img src="https://i.stack.imgur.com/qq8AE.gif" data-src="https://res.cloudinary.com/elonatech/image/upload/v1709724295/videoConferencingPage/webcam_xobc6j.jpg" alt="" className='img-fluid lazyload'/>
              </div>
            </div>
            <div class="col-md-4">
