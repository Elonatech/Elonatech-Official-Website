...
const WebCareer = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Full Stack Software Developer Careers - Build and Optimize Websites
          from Start to Finish
        </title>
        <meta
          name="description"
          content="This is a full-time on-site role for a Full Stack Software Developer. The Full Stack Software Developer will be responsible for
        ...
        <div class="row justify-content-center mt-3">
          <div class="col-md-6 ">
            ...
            <p className="text-justify">
              This is a full-time on-site role for a Full Stack Software
              Developer. The Full Stack Software Developer will be responsible
              for creating designs and developing websites from conception all
              the way up to completion, fashioning everything from the home page
              to site layout, optimization and function. The Full Stack Software
              Developer will work closely with the design (UI/UX) and
            ...
            <ul>
              ...
              <li>
                Software Developer responsibilities include building websites
                from concept all the way to completion from the bottom up,
                fashioning everything from the home page to site layout,
