  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="  Toju Okene-Joe is a professional graphics, motion graphics and UI/UX designer with over 5 years of experience using industry standard tools such as the Adobe 
          ...
          <div className="col-md-8">
            <div className="card border-0">
              <h1 className="fw-bold" style={{ color: "#34548c" }}>
                Toju Isaac Okene-Joe
              </h1>
              <h6 className="text-danger mt-0">
                Creative Designer | Team Lead
              </h6>
              <p>
                Toju Okene-Joe is the Creative Designer and Team Lead at
                Elonatech Nigeria Limited, with over five years of professional
                experience in digital design, motion graphics, and user
                experience design. Known for his creativity and precision, Toju
                delivers high-impact visual experiences that blend strategy,
                storytelling, and aesthetics to communicate value with clarity
                and emotion.
              </p>
              <p>
                A highly skilled designer, Toju is proficient in
                industry-standard tools such as Adobe Photoshop, Illustrator,
                After Effects, Premiere Pro, CorelDraw, and Figma. His expertise
                covers branding, motion graphics, UI/UX design, and digital
                content creation, consistently producing designs that are
                visually engaging, user-focused, and technically refined.
              </p>
              <p>
                Prior to Elonatech, Toju built a strong professional foundation
                through roles in freelance and various creative establishments,
                where he worked on projects spanning digital advertising,
                animation, brand identity, print media, and promotional
                campaigns. His diverse experience across different industries
                has equipped him with the versatility to adapt to evolving
                creative and technological demands.
              </p>
              <p>
                Okene-Joe holds a National Diploma (ND) in Mechanical
                Engineering from Yaba College of Technology, and furthered his
                academic journey at the Federal University of Petroleum
                Resources, Effurun, where he studied Geophysics and Seismology.
                In addition, he has earned professional certifications in
                Graphics Design and an Executive Diploma in UI/UX Design,
                underscoring his commitment to continuous learning and growth.
              </p>
              <p>
                As a performance-driven and visionary creative leader, Toju
                inspires innovation and collaboration within his team, driving
                the creation of designs that not only look exceptional but also
                perform with purpose. Outside work, he enjoys reading, watching
                movies, listening to music, and exploring new ideas that
                challenge creative boundaries.
              </p>
            </div>
          </div>
        </div>
