  ...
  return (
    <>
        ...
        <div class='row align-items-center'>
          <div class='col-lg-4 col-6 mb-5'>
            <div class='card border-0'>
              ...
              <h6 className='text-center mt-3'>Basic | Standard | Premium</h6>
          ...
          <div class='col-lg-4 col-6 mb-5'>
            <div class='card border-0'>
              ...
              <h6 className='text-center mt-3'>E1 | E2 | E5</h6>
          ...
          <div class='col-lg-4 col-6 mb-5'>
            <div class='card border-0'>
              ...
              <h6 className='text-center mt-3'>Kiosk | Plan 1 | Plan 2</h6>
          ...
          <div class='col-lg-4 col-6'>
            <div class='card border-0'>
              ...
              <h6 className='text-center mt-3'>Plan 1 | Plan 2 </h6>
      ...
      <div class='container mt-5'>
        <h2 className='text-center fw-bold mb-3'>Microsoft Windows</h2>
        <div class='row'>
          <div class='col mb-5'>
            <div class='card border-0'>
              <div className='text-center'>
        ...
        <div class='row'>
          <div class='col-md-6 mb-5'>
            <div class='card border-0'>
              ...
              <h6 className='text-center mt-3'> Standard | Enterprise</h6>
        ...
        <div class='row'>
          <div class='col-lg-3 col-md-6'>
            <div class='card border-0'>
              ...
              <h4 className=''>Norton™ AntiVirus Plus</h4>
          ...
          <div class='col-lg-3 col-md-6'>
            <div class='card border-0'>
              ...
              <h4 className=''>Norton™ 360 + Backup</h4>
              <ul className='list-unstyled'>
                <li className=''>
                  {' '}
                  <i class='bi bi-circle-fill text-danger me-2'></i>1 PC, Mac,
          ...
          <div class='col-lg-3 col-md-6'>
            <div class='card border-0'>
              ...
              <h4 className=''>Norton™ Family Premier</h4>
              <ul className='list-unstyled'>
                <li className=''>
                  {' '}
          ...
          <div class='col-lg-3 col-md-6'>
            <div class='card border-0'>
              ...
              <h4 className=''>Norton™ Mobile Security</h4>
              <ul className='list-unstyled'>
                <li className=''>
                  {' '}
        ...
        <div class='row mt-5'>
          ...
          <div class='col-md-4 mb-5'>
            <div class='card border-0'>
              ...
              <h4 className=''>Kaspersky Plus Internet Security</h4>
              <ul className='list-unstyled'>
                <li className=''>
                  {' '}
                  <i class='bi bi-circle-fill text-danger me-2'></i>Performance
          ...
          <div class='col-md-4 mb-5'>
            <div class='card border-0'>
              ...
              <h4 className=''>Kaspersky Premium Total Security</h4>
              <ul className='list-unstyled'>
                <li className=''>
                  {' '}
                  <i class='bi bi-circle-fill text-danger me-2'></i>Unlimited
        ...
        <div class='row justify-content-center  g-2'>
          ...
          <div class='col-md-6'>
            ...
            <p>
              ...
              <div className='taj'>
                <i class='bi bi-circle-fill text-danger me-2'></i>
                <span className='text-dark fw-bold'>Service changes: </span>
                Add or change any services included in Office 365, including
                Microsoft Teams, OneDrive, Exchange Online, SharePoint Online,
                Yammer, PowerApps and Flow Security and compliance: Includes
                application configuration and changes to rules, policies or
                services.
              </div>
            </p>
          </div>
