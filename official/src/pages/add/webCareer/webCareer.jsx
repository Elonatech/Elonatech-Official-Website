...
const WebCareer = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Full Stack Software Developer Careers - Build and Optimize Websites from Start to Finish
        </title>
        <meta
          name='description'
        ...
        <div class='row justify-content-center mt-3'>
          <div class='col-md-6 '>
            ...
            <p className='text-justify'>
              This is a full-time on-site role for a Full Stack Software Developer.
              The Full Stack Software Developer will be responsible for creating
              ...
              layout, optimization and function. The Full Stack Software Developer
            ...
            <ul>
              ...
              <li>
                Software Developer responsibilities include building websites from
